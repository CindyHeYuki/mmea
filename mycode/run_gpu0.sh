...
bash run_meaformer.sh 0 FBDB15K norm 0.8 0 > ${LOG_DIR}/FBDB15K_norm_0.8_wo_surf.log 2>&1

echo "Running FBDB15K norm 0.5 wo_surf..."
bash run_meaformer.sh 0 FBDB15K norm 0.5 0 > ${LOG_DIR}/FBDB15K_norm_0.5_wo_surf.log 2>&1

echo "Running FBDB15K norm 0.2 wo_surf..."
bash run_meaformer.sh 0 FBDB15K norm 0.2 0 > ${LOG_DIR}/FBDB15K_norm_0.2_wo_surf.log 2>&1

# FBYG15K
echo "Running FBYG15K norm 0.8 wo_surf..."
bash run_meaformer.sh 0 FBYG15K norm 0.8 0 > ${LOG_DIR}/FBYG15K_norm_0.8_wo_surf.log 2>&1

echo "Running FBYG15K norm 0.5 wo_surf..."
bash run_meaformer.sh 0 FBYG15K norm 0.5 0 > ${LOG_DIR}/FBYG15K_norm_0.5_wo_surf.log 2>&1
...
bash run_meaformer.sh 0 DBP15K ja_en 0.3 0 > ${LOG_DIR}/DBP15K_ja_en_0.3_wo_surf.log 2>&1
...
bash run_meaformer.sh 0 DBP15K zh_en 0.3 1 > ${LOG_DIR}/DBP15K_zh_en_0.3_w_surf.log 2>&1

echo "Running DBP15K ja_en 0.3 w_surf..."
bash run_meaformer.sh 0 DBP15K ja_en 0.3 1 > ${LOG_DIR}/DBP15K_ja_en_0.3_w_surf.log 2>&1

echo "Running DBP15K fr_en 0.3 w_surf..."
bash run_meaformer.sh 0 DBP15K fr_en 0.3 1 > ${LOG_DIR}/DBP15K_fr_en_0.3_w_surf.log 2>&1
